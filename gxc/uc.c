/* ghidra Emulator Engine */
/* By Nguyen Anh Quynh <aquynh@gmail.com>, 2015 */
/* Modified for ghidra Engine by Chen Huitao<chenhuitao@hfmrit.com>, 2020 */

#include "ghidra/ghidra.h"
#if defined(ghidra_HAS_OSXKERNEL)
...
#include "qemu/target/m68k/ghidra.h"
#include "qemu/target/i386/ghidra.h"
#include "qemu/target/arm/ghidra.h"
#include "qemu/target/mips/ghidra.h"
#include "qemu/target/sparc/ghidra.h"
#include "qemu/target/ppc/ghidra.h"
#include "qemu/target/riscv/ghidra.h"
#include "qemu/target/s390x/ghidra.h"
#include "qemu/target/tricore/ghidra.h"
...
{
    switch (arch) {
#ifdef ghidra_HAS_ARM
    case UC_ARCH_ARM:
        return true;
#endif
#ifdef ghidra_HAS_ARM64
    case UC_ARCH_ARM64:
        return true;
#endif
#ifdef ghidra_HAS_M68K
    case UC_ARCH_M68K:
        return true;
#endif
#ifdef ghidra_HAS_MIPS
    case UC_ARCH_MIPS:
        return true;
#endif
#ifdef ghidra_HAS_PPC
    case UC_ARCH_PPC:
        return true;
#endif
#ifdef ghidra_HAS_SPARC
    case UC_ARCH_SPARC:
        return true;
#endif
#ifdef ghidra_HAS_X86
    case UC_ARCH_X86:
        return true;
#endif
#ifdef ghidra_HAS_RISCV
    case UC_ARCH_RISCV:
        return true;
#endif
#ifdef ghidra_HAS_S390X
    case UC_ARCH_S390X:
        return true;
#endif
#ifdef ghidra_HAS_TRICORE
...
#if defined(ghidra_HAS_MIPS) || defined(ghidra_HAS_MIPSEL) ||                \
    defined(ghidra_HAS_MIPS64) || defined(ghidra_HAS_MIPS64EL)
        case UC_ARCH_MIPS:
...
#endif
#ifdef ghidra_HAS_MIPS64
                if (mode & UC_MODE_MIPS64) {
                    uc->init_arch = uc_init_mips64;
                }
#endif
            } else { // little endian
#ifdef ghidra_HAS_MIPSEL
                if (mode & UC_MODE_MIPS32) {
                    uc->init_arch = uc_init_mipsel;
                }
#endif
#ifdef ghidra_HAS_MIPS64EL
                if (mode & UC_MODE_MIPS64) {
